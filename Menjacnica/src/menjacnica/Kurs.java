...
public class Kurs {
	...
	public Kurs(GregorianCalendar datum, double srednji, double kupovni, double prodajni) {
		super();
		this.datum = datum;
	...
	public String toString() {
		return "Kurs [datum=" + datum.getTime() + ", srednji=" + srednji + ", kupovni=" + kupovni + ", prodajni=" + prodajni
				+ "]";
	}
	@Override
	public int hashCode() {
